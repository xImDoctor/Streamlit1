...
# предупреждение, что мультиселект пустой (не можем построить визуализацию): если строка msg есть, то с пояснением дейсвтия, иначе простое
...
with correlation_tab:
    ...
    gender_is_not_selected_message("Чтобы построить матрицу и тепловую карту")
